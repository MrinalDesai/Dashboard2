...
st.write(""" """)
st.subheader("#️⃣Low Vehicle Ownership📌 ", divider="gray")
...
st.subheader("#️⃣📌 From 1.6% in 1998-99, car owners now 8% of Indian families:", divider="gray")
...
st.write("""Before the 1990s, owning a car was a herculean task in India. Loans were fewer, and automobile brands limited.
        ...
        by 8 per cent of families, with 42 per cent of the surveyed households owing bicycles.
         ...
         \nThe number of car-owning families is higher in cities — around 14 per cent of families surveyed in urban India 
